...
Usage:
  python run_audit_pipeline.py --watch               # Live worker watching incoming downloads
  python run_audit_pipeline.py --batch               # Process all pending downloaded PDFs in batch
  python run_audit_pipeline.py --file path/to/doc.pdf # On-demand instant audit for 1 work
================================================================================
"""
