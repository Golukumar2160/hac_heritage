...
================================================================================
Location: scripts/download_pdfs_live.py
...
Usage:
  python scripts/download_pdfs_live.py --limit 3500
  python scripts/download_pdfs_live.py --limit 5000 --delay 1.0
  python scripts/download_pdfs_live.py --limit 500 --state "Uttar Pradesh"
================================================================================
"""
...
DEFAULT_OUTPUT_DIR = os.path.join(ROOT_DIR, "images", "downloaded_pdfs")
REGISTRY_CACHE_PATH = os.path.join(ROOT_DIR, "forensics", "works_with_images_registry.json")
