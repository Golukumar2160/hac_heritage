...
| **Ensemble Precision (CRITICAL+HIGH)** | **76.51%** | Evaluated against ground-truth statutory labels |
| **Ensemble Recall** | **73.93%** | Percentage of statutory violations captured |
| **Ensemble F1 Score** | **75.2%** | Balanced harmonic mean |
| **Model Generalization AUC-ROC** | **0.8748** | 80/20 Stratified train-test split |
